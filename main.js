...
/* harmony import */ var _components_practice__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/practice */ "./src/js/components/practice.js");
/* harmony import */ var _components_var__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/var */ "./src/js/components/var.js");
/* harmony import */ var _components_var__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_components_var__WEBPACK_IMPORTED_MODULE_7__);
...
let durationTotal = document.querySelector('.exp__title-durationTotal');
...
window.addEventListener('scroll', () => {
  if (window.scrollY > 120) {
    header.classList.add('d-fixed');
    header.style.borderBottomLeftRadius = '30px';
    header.style.borderBottomRightRadius = '30px';
    header.style.animation = 'upDown 1000ms forwards';
  } else {
    header.classList.remove('d-fixed');
    header.style.animation = 'show 500ms forwards';
    //header.style.animation = 'none';
  }

  //if (window.scrollY > 110 || window.scrollX < 150) {
  //    header.style.animation = 'downUp 500ms forwards';
  //}

  if (header.classList.contains('d-fixed')) {
    main.style.paddingTop = '97.5px';
  } else {
...
//    root.style.setProperty('--color-blueNavy', '#0475F1')
//} else {
//    root.style.removeProperty('--color-white')
//    root.style.removeProperty('--color-black')
//    root.style.removeProperty('--color-blueNavy')
//}

//checkbox.addEventListener('change', (event) => {
//    sw.classList.toggle('switch-bg')
//    sw.classList.toggle('switch-border')
...
window.addEventListener('scroll', function () {
  ...
  firstTranslateX = -percentageScrolled / 100 * (firstTitle.offsetWidth + window.innerWidth), secondTranslateX = percentageScrolled / 100 * (secondTitle.offsetWidth + window.innerWidth) - secondTitle.offsetWidth;
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Parallax, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay]);
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.practice__swiper', {
  parallax: true,
  speed: 700,
  loop: true,
...
const swiperOther = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.practice__swiper-other', {
  speed: 700,
  loop: true,
  autoplay: {
    delay: 5000,
